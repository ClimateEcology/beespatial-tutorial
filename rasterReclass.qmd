...
A formatted reclassification table based on Koh et al. is <a href="data/cdl_reclass_koh.csv" download>available here</a>. The table rows connect each CDL value to its corresponding class name and the values for several indices.
