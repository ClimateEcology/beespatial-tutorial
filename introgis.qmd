...
This page serves as a brief overview of the geographic information systems (GIS) concepts and R packages to get you up and running with the R-based modules in this tutorial. For more in-depth introduction GIS in R, you may want to look [elsewhere](https://www.ecologi.st/spatial-r/) on the [web](https://bookdown.org/michael_bcalles/gis-crash-course-in-r/).
