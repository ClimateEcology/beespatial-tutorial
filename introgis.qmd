...
Before working with the data layers from BeeSpatial in R, here are some geographic information systems (GIS) terms and concepts that are necessary to understand. For a more in-depth introduction to GIS in R, you may want to look [elsewhere](https://www.ecologi.st/spatial-r/) on the [web](https://bookdown.org/michael_bcalles/gis-crash-course-in-r/).
